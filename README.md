...
This workshop provides an introduction to multi-agent systems (Agent-Based Models).
The goal is to understand and model the emergence of natural, physical, or biological phenomena using this paradigm.
